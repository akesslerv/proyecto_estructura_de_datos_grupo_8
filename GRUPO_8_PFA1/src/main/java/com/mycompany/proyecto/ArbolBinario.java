...
public class ArbolBinario {
    ...
    // Laboratorio y Farmacia: Puedes agregar preguntas aquí según lo requiera el sistema.
    // Ejemplo:
    // Pregunta preguntaLab = new Pregunta("1", "¿Qué pruebas realiza el laboratorio?", "Realizamos pruebas de sangre, orina y más.");
    // nodoLaboratorio.getListaPreguntas().setCabeza(preguntaLab);
    return raiz;
    }
